import {Card , Logo , Content , Span , Short} from '../../../components/HomePage/ChildComponent/HomeDashboard.js';
export const StatusCard = ({ handleClickd, icon, content, title, detail, value }) => {
  ...
  } else if (title === 'Medicine available') {
  ...
  return (
    <Card style={borderStyle}>   {/* now passing an object */}
      <Logo>{icon}</Logo>
      <div>
        <Content style={{ fontFamily: '"DM Sans", sans-serif' , fontSize:"20px" }}>
          {content}
        </Content>
